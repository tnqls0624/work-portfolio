...
var paramCampaignInfo = function(){
	...
	if (window.innerWidth < 641) {
		$('#navi_main_small').prepend('<div id="balloon_navi" class="crnt_home"><p><a id="dpc_gnavi_balloon" href="/store/index.html" data-portalarea="dpc_gnavi_balloon">dポイントがつかえるお店をチェック！</a><span class="btn_close"><img src="/common/img/button/comment_close.png" /></span></p></div>');
		if(elem === undefined){
		...
		if(getParam('utm_campaign') === 'dpc_201902_tvcm-top'){
			...
			if(!(pubreplace === $.cookie("tabcok"))){
			 	if(checkDate_display(publishedDate, closeDate)){
					$('#navi_main_small').prepend('<div id="balloon_navi" class="'+ crnt_class +'"><p><a id="dpc_gnavi_balloon" href="'+ anchor_url +'" data-portalarea="dpc_gnavi_balloon">'+ text +'</a><span class="btn_close"><img src="/common/img/button/comment_close.png" /></span></p></div>');
